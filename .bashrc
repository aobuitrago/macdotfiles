...
alias cl='clear'
alias du='du -ch -d 1'
#It is possible to install the tree command on macOS X using brew for example
#alias treeacl='tree -A -C -L 2'
#If tree command is not installed use the command below
alias treeacl="find . -print | sed -e 's;[^/]*/;|____;g;s;____|; |;g'"
...
# 2.5) Install rlwrap if not present
